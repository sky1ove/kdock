...
# %% auto 0
__all__ = ['ChainSelect', 'rename_residues', 'split_cif', 'pdb2sdf', 'prepare_rec_lig', 'gnina_rescore', 'extract_gnina_rescore',
           'get_gnina_rescore', 'get_gnina_rescore_folder']
...
def get_gnina_rescore(cif_path):
    ...
    gnina_output = gnina_rescore(rec_path,lig_path)
    return extract_gnina_rescore(gnina_output)

# %% ../nbs/05_gnina_AF3_rescore.ipynb 23
def get_gnina_rescore_folder(cif_folder):
    ...
    results = process_map(get_gnina_rescore, cifs, max_workers=4)
