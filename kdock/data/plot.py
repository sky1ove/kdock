...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/data/01_plot.ipynb.

# %% auto 0
__all__ = ['set_sns', 'reduce_feature', 'plot_2d', 'plot_corr', 'view_mol', 'view_complex']

# %% ../../nbs/data/01_plot.ipynb 3
...
# %% ../../nbs/data/01_plot.ipynb 5
def set_sns():
    sns.set(rc={"figure.dpi":300, 'savefig.dpi':300})
    sns.set_context('notebook')
    sns.set_style("ticks")

# %% ../../nbs/data/01_plot.ipynb 6
