...
def rename_residues(
    structure, chain_id, new_resname:str='LIG'
):
...
def split_cif(
    cif_path, rec_chain_id, lig_chain_id, rec_pdb_path, lig_pdb_path
):
...
def gnina_rescore_local(
    protein_pdb, # receptor file
    ligand_sdf, # ligand file
    CNN_affinity:bool=True, vinardo:bool=False, # if True, use vinardo instead of vina
):
...
def gnina_rescore_docker(
    protein_pdb, ligand_sdf, CNN_affinity:bool=True, vinardo:bool=False
):
...
def get_gnina_rescore(
    cif_path, rec_chain_id:str='A', lig_chain_id:str='L', CNN_affinity:bool=True, vinardo:bool=False,
    is_local:bool=True
):
...
def get_gnina_rescore_folder(
    cif_folder, rec_chain_id:str='A', lig_chain_id:str='L', CNN_affinity:bool=True, vinardo:bool=False,
    is_local:bool=True
):
