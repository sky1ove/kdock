...
def process_summary_df(
    df, generate_report:bool=False
):
...
def get_3d_report(
    df, index_list, x:str='iptm', y:str='ptm', z:str='chain_pair_pae_min_add', save_dir:str='af_report'
):
...
def get_report(
    out_dir, save_dir:str='af_report'
):
